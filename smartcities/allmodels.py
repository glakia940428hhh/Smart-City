...
class Event(models.Model):
    eventid = models.CharField(db_column='eventId', primary_key=True, max_length=20)  # Field name made lowercase.
...
class Observreport(models.Model):
    observid = models.CharField(db_column='observId', primary_key=True, max_length=20)  # Field name made lowercase.
    date = models.DateField(blank=True, null=True)
    observname = models.CharField(db_column='observName', max_length=20, blank=True, null=True)  # Field name made lowercase.
    overflow = models.CharField(max_length=20, blank=True, null=True)
